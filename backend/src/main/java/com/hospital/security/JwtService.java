...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails, UUID hospitalId, String hospitalName, String role) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("hospitalId",   hospitalId != null ? hospitalId.toString() : null);
