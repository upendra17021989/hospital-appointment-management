...
public class PatientController {
    ...
    @GetMapping("/search")
    @Operation(summary = "Search patient by phone")
    public ResponseEntity<ApiResponse<List<PatientResponse>>> searchByPhone(
            @RequestParam String phone) {
        return ResponseEntity.ok(ApiResponse.success(patientService.searchByPhone(phone)));
    }
